...
See also: [Information Organization](/Information%20Organization/Information%20Organization%20Workflow.md)
...
### A. Manual Creation of Data Catalog
...
### B. Data Catalog via Automatic Inventory
...
<p align="center">
<img width="" alt="image" src="/Data Catalog/images/DataCatalog_B1_1.png">
</p>
...
<p align="center">
<img width="" alt="image" src="/Data Catalog/images/DataCatalog_B1_2.png">
</p>
...
<p align="center">
<img width="" alt="image" src="/Data Catalog/images/DataCatalog_B1_3.png">
</p>

4. Click the “Close and Load” button at the top left corner on the menu; the data will then populate in the sheet.

<p align="center">
<img width="" alt="image" src="/Data Catalog/images/DataCatalog_B1_4.png">
</p>
...
<p align="center">
<img width="" alt="image" src="/Data Catalog/images/DataCatalog_B2_2.png">
</p>
...
<p align="center">
<img width="" alt="image" src="/Data Catalog/images/DataCatalog_B2_4.png">
</p>
...
<p align="center">
<img width="" alt="image" src="/Data Catalog/images/DataCatalog_B2_5.png">
</p>

6. The new file will be populated with the following information:

     a. Name: name of the file or folder with a link to its online version
     
     b. Modified: the date when the item was modified

     c. Modified by: name of the user who modified the item last

     d. Item type: “item” refers to files, “folder” refers to folders

     e. Path: the path within folder hierarchy (no link to the online content).
...
<p align="center">
 <img width="" alt="image" src="/Data Catalog/images/DataCatalog_B2_8.png">
</p>
...
<p align="center">
<img width="" alt="image" src="/Data Catalog/images/DataCatalog_B2_8b.png">
</p>
...
<p align="center">
<img width="" alt="image" src="/Data Catalog/images/DataCatalog_B3_1.png">
</p>
2. Add the App Script to the document:

   a. Go to "Extensions"-> "Apps Script".
 <p align="center">  
   <img width="" alt="image" src="/Data Catalog/images/DataCatalog_B3_2.png">
</p>
   b. In the App Script that opens, remove any content that is there and paste the code block from the end of this section (if needed, the metadata fields to be collected can be changed and/or reordered in the last section of code).
  <p align="center">
     <img width="" alt="image" src="/Data Catalog/images/DataCatalog_B3_2b.png">
</p>
  a. Give the script a meaningful name (e.g., “FileList”), then save the project by clicking on the diskette icon at the top. Click “Run”.
  b. Close the tab with the Apps Script and the tab with the google sheet, then reopen the sheet. You will now see a new menu option named “File List”. 
...
<p align="center">
     <img width="" alt="image" src="/Data Catalog/images/DataCatalog_B3_3a.png">
</p>
...
<p align="center">
     <img width="" alt="image" src="/Data Catalog/images/DataCatalog_B3_3b.png">
</p>
